        ...
        <div class="card-body">
          <form action="{{ route('estates.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="broker" id="broker" class="form-control" value="{{ old('broker') }}"
                required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="paths" id="paths" class="form-control" value="{{ old('paths') }}"
                required>
            </div>
            <div class="mb-3">
